...
public final class WormholeMoveSkillDisabler {
    ...
    public static void disable() {
        UltraBiomeGone.debugLog("WormholeMoveSkillDisabler: disabling open_wormhole move skill");
        ...
        if (skill == null) {
            ...
            UltraBiomeGone.debugLog("WormholeMoveSkillDisabler: open_wormhole skill was null (already removed or not loaded)");
            return;
        }
        UltraBiomeGone.debugLog("WormholeMoveSkillDisabler: found open_wormhole skill, replacing behaviourNoTarget");
        skill.behaviourNoTarget(pixelmon -> {
            LivingEntity owner = pixelmon.getOwner();
            if (owner instanceof Player player) {
                UltraBiomeGone.debugLog("WormholeMoveSkillDisabler: open_wormhole used by player {} — fizzling", player.getGameProfile().getName());
